...
const UR_STRINGS = {
  ...
  mood_board: 'موڈ بورڈ',
  navigator: 'نیویگیٹر',
  navigator_header: 'ویژنری کیئر نیویگیٹر',
  navigator_sub: 'ادارہ جاتی پروٹوکول اور ریئل ٹائم وسائل کے ساتھ درست طبی روڈ میپس۔',
  med_scanner: 'میڈ اسکینر',
  meds_scanner_header: 'ویژن اے آئی میڈ اسکینر',
  meds_scanner_sub: 'کیمیائی مرکبات، حفاظتی انتباہات اور طبی ہدایات کا درست تجزیہ۔',
  doc_intel: 'دستاویز انٹیل',
  doc_intel_header: 'دستاویز انٹیل والٹ',
  doc_intel_sub: 'رپورٹس کو محفوظ کریں اور اے آئی کو سیاق و سباق بیان کرنے دیں۔',
  insights: 'بصیرت مرکز',
  insights_header: 'بصیرت مرکز',
  insights_sub: 'طبی خبریں، تصدیق شدہ پورٹلز اور ماہر گائیڈز۔',
  trust: 'بھروسہ',
  ...
  unified_sanctuary: 'متحدہ نگہداشت پناہ گاہ',
  comfort_recovery_desc: 'آپ کے آرام اور صحت یابی کے لیے آسان ٹولز۔',
...
const TE_STRINGS = {
  ...
  navigator_sub: 'సంస్థాగత ప్రోటోకాల్స్ మరియు నిజ-సమయ వనరులతో ఖచ్చితంగా మ్యాప్ చేయబడిన క్లినికల్ రోడ్‌మ్యాప్స్.',
  med_scanner: 'మెడిసిన్ స్కానర్',
  meds_scanner_header: 'విజన్-AI మెడ్ స్కానర్',
  meds_scanner_sub: 'ఔషధాల రసాయన సమ్మేళనాలు, భద్రతా హెచ్చరికల యొక్క ఖచ్చితమైన విశ్లేషణ.',
  ...
  magic_energy_needed: 'తదుపరి పవర్-アップ కోసం XP',
